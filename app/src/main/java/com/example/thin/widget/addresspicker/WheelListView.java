...
/**
 * Created by xingyan on 2018/1/5 10:22.
 * Email:lucky_xyic@sina.cn
 * ToDo:滑轮控件，参见：https://github.com/addappcn/AndroidPicker
 */
...
public class WheelListView extends ListView implements ListView.OnScrollListener, View.OnTouchListener,
    ...
    public static final int TEXT_COLOR_FOCUS = 0XFF080808;
    public static final int TEXT_COLOR_NORMAL = 0XFFBBBBBB;

    public static final int ITEM_OFF_SET = 2;
    public static final int ITEM_HEIGHT = 50;//dp
    public static final int ITEM_PADDING_TOP_BOTTOM = 10;//dp
    public static final int ITEM_PADDING_LEFT_RIGHT = 8;//dp
    ...
    private void refreshCurrentPosition() {
        ...
        if (adapter.isLoop() && firstPosition == 0) {
            Log.d(TAG, "is loop and first visible position is 0");
            return;
        }
        int position;
    ...
    private void refreshTextView(int position, int curPosition, View
        ...
        //   Log.d(TAG,"position=" + position + ", curPosition=" + curPosition);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.d(TAG, "press down: currentPosition=" + currentPosition);
                break;
            case MotionEvent.ACTION_UP:
                Log.d(TAG, "press up: currentItem=" + getSelectedItem());
                break;
        }
        return false;
    }
    ...
    private static class ItemView extends LinearLayout {
        ...
        private void init(Context context) {
            ...
            int paddingTopBottom = ScreenUtil.dip2px(context, ITEM_PADDING_TOP_BOTTOM);
            int paddingLeftRight = ScreenUtil.dip2px(context, ITEM_PADDING_LEFT_RIGHT);
            setPadding(paddingLeftRight, paddingTopBottom, paddingLeftRight, paddingTopBottom);
            setGravity(Gravity.CENTER);
            int height = ScreenUtil.dip2px(context, ITEM_HEIGHT);
            ...
            imageParams.rightMargin = ScreenUtil.dip2px(context, ITEM_MARGIN);
