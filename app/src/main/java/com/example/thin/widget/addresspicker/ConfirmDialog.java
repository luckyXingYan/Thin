...
/**
 * Created by xingyan on 2018/1/5 10:06.
...
public abstract class ConfirmDialog<V extends View> extends BaseDialog<View> {
    ...
    protected int cancelTextColor = 0XFF989898;
//    protected int submitTextColor = 0XFF59c8d3;
    protected int submitTextColor = 0XFFdd0201;
    protected int titleTextColor = Color.BLACK;
    protected int pressedTextColor = 0XFF3fb1bc;
    ...
    protected final View makeContentView() {
        ...
        if (topLineVisible) {
            ...
            int height = ScreenUtil.dip2px(activity, topLineHeight);
    ...
    protected View makeHeaderView() {
        ...
        int height = ScreenUtil.dip2px(activity, topHeight);
        ...
        int padding = ScreenUtil.dip2px(activity, topPadding);
...
//        cancelButton.setTextColor(toColorStateList(cancelTextColor, pressedTextColor));
        cancelButton.setTextColor(toColorStateList(cancelTextColor, cancelTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = ScreenUtil.dip2px(activity, topPadding);
...
//        submitButton.setTextColor(toColorStateList(submitTextColor, pressedTextColor));
        submitButton.setTextColor(toColorStateList(pressedTextColor, pressedTextColor));
        if (submitTextSize != 0) {
